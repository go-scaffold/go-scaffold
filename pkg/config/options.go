...
type Options struct {
	...
	RemoveConfig bool           `short:"r" long:"remove-config" description:"Flag to indicate whether remove the template and config files, or not. This has effect only if the input and output folder are the same"`
