...
func Test_NewPatternFilter_Success_ValidPatterns(t *testing.T) {
	filter, err := scaffold.NewPatternFilter("pattern1", "pattern1")
...
func Test_NewPatternFilter_Fail_ShouldReturnErrorIfOneOFThePatternIsInvalid(t *testing.T) {
	filter, err := scaffold.NewPatternFilter("pattern1", "invalid pattern [")
...
func Test_Accept_ShouldReturnFalseIfTheFileNameMatchesThePatterns(t *testing.T) {
	filter, err := scaffold.NewPatternFilter("non-matching-expression", ".*file-to-match.*")
	assert.Nil(t, err)
	assert.NotNil(t, filter)
...
func Test_Accept_ShouldReturnTrueIfTheFileNameDoesNotMatcheThePatterns(t *testing.T) {
	filter, err := scaffold.NewPatternFilter("non-matching-expression-1", "non-matching-expression-2")
	assert.Nil(t, err)
	assert.NotNil(t, filter)
